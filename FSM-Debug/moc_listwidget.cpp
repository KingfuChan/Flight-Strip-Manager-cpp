...
QT_MOC_LITERAL(1, 17, 9), // "resetItem"
QT_MOC_LITERAL(2, 27, 0), // ""
QT_MOC_LITERAL(3, 28, 16), // "QListWidgetItem*"
QT_MOC_LITERAL(4, 45, 10), // "deleteItem"
QT_MOC_LITERAL(5, 56, 11), // "showContext"
QT_MOC_LITERAL(6, 68, 12) // "calcSequence"

    },
    "CustomListWidget\0resetItem\0\0"
    "QListWidgetItem*\0deleteItem\0showContext\0"
    "calcSequence"
};
...
void CustomListWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->resetItem((*reinterpret_cast< QListWidgetItem*(*)>(_a[1]))); break;
        case 1: _t->deleteItem((*reinterpret_cast< QListWidgetItem*(*)>(_a[1]))); break;
        case 2: _t->showContext((*reinterpret_cast< QPoint(*)>(_a[1]))); break;
        case 3: _t->calcSequence(); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&CustomListWidget::resetItem)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (CustomListWidget::*)(QListWidgetItem * );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&CustomListWidget::deleteItem)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void CustomListWidget::resetItem(QListWidgetItem * _t1)
{
...
// SIGNAL 1
void CustomListWidget::deleteItem(QListWidgetItem * _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))) };
